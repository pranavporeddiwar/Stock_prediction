...
class PredictionService:
    ...
    def generate_forecast(self, df: pd.DataFrame):
        ...
        try:
            ...
            # 2. Recursive Inference Loop (25-step lookahead)
            ...
            for _ in range(self.forecast_steps):
                ...
                # Maintain constant technical indicator influence for the prediction window
                next_vec = [pred, 0.0, 0.0, current_window[-1][3], current_window[-1][4], current_window[-1][5]]
                current_window.append(next_vec)
                predicted_prices.append(pred)

            # 3. Denormalization (Reconstruct absolute price values)
            if self.scaler:
            ...
            # 4. JSON Path Construction for Graph Mapping
